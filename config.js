...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~xpBaHBvTz68vkG8EW5Pt",  // Your bot's session ID (keep it secure)
    PREFIX: getConfig("PREFIX") || ".",  // Command prefix (e.g., "., / ! * - +")
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "MR-IRTEZA-MD",  // Bot's display name
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "923249292306",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "Mr Irteza",           // Owner's name
    DEV: process.env.DEV || "923249292306",                     // Developer's contact number
    DEVELOPER_NUMBER: '923249292306@s.whatsapp.net',            // Developer's WhatsApp ID
    ...
    BOT_IMAGE: getConfig("BOT_IMAGE") || "https://i.postimg.cc/3RbPHpB8/IMG-20250525-WA0152.jpg",  // Bot's "alive" image
    ...
    FOOTER: process.env.FOOTER || "*© Powered By Mr Irteza Hacker*",  // Bot description
